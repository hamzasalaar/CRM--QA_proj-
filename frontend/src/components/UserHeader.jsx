    ...
    <header className="user-header">
      <div className="header-container">
        <Link to="/user" className="logo">
          User<span className="logo-text">Portal</span>
        </Link>
        ...
        <nav className={`nav ${menuOpen ? "active" : ""}`}>
          ...
          <Link to="/user/tasks" className="nav-link">My Tasks</Link>
          <Link to="#" className="nav-link">Team Requests</Link> {/* Updated link */}
        </nav>
